...
def cargar_imagenes()-> pg.Surface:
    ...
    """
    fondo = pg.image.load("PROGRAMACION_I_SP/static/img/SEA_BATTLE.PNG")
...
def cargar_fuentes()-> tuple:
    ...
    """
    fuente_normal = pg.font.Font("PROGRAMACION_I_SP/static/font/ka1.ttf", 18)
    fuente_grande = pg.font.Font("PROGRAMACION_I_SP/static/font/ka1.ttf", 25)
...
def cargar_sonidos()-> tuple:
    ...
    """
    pg.mixer.music.load("PROGRAMACION_I_SP/static/sound/Piratas del  caribe  cancion completa - android juegos.mp3")
    pg.mixer.music.set_volume(0.1)
    sonido_barco = pg.mixer.Sound("PROGRAMACION_I_SP/static/sound/impacto_barco.mp3")
    sonido_barco.set_volume(0.3)
    sonido_agua = pg.mixer.Sound("PROGRAMACION_I_SP/static/sound/impacto_agua.mp3")
    sonido_agua.set_volume(0.5)
    sonido_hundido = pg.mixer.Sound("PROGRAMACION_I_SP/static/sound/barco_hundido.mp3")
